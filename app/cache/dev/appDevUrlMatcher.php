...
class appDevUrlMatcher extends Symfony\Bundle\FrameworkBundle\Routing\RedirectableUrlMatcher
{
    ...
    public function match($pathinfo)
    {
        ...
        if (preg_match('#^/(?P<id>[^/]++)/addInsect$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'project_insect_addFriend')), array (  '_controller' => 'Project\\InsectBundle\\Controller\\InsectController::addAction',));
        }

        // project_insect_deleteFriend
        if (preg_match('#^/(?P<id>[^/]++)/deleteInsect$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'project_insect_deleteFriend')), array (  '_controller' => 'Project\\InsectBundle\\Controller\\InsectController::deleteAction',));
        }

        // project_insect_listRequest
        if ($pathinfo === '/listRequest') {
            return array (  '_controller' => 'Project\\InsectBundle\\Controller\\FriendshipController::listAction',  '_route' => 'project_insect_listRequest',);
        }

        // project_insect_sendRequest
        if (preg_match('#^/(?P<id>[^/]++)/sendRequest$#s', $pathinfo, $matches)) {
            return $this->mergeDefaults(array_replace($matches, array('_route' => 'project_insect_sendRequest')), array (  '_controller' => 'Project\\InsectBundle\\Controller\\FriendshipController::sendAction',));
        }

        // project_insect_deleteRequest
        if (preg_match('#^/(?P<id>[^/]++)/deleteRequest$#s', $pathinfo, $matches)) {
